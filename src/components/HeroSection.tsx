    ...
    <section id="home" className="min-h-screen flex flex-col justify-center pt-16 pb-8 section">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <div className="order-2 lg:order-1">
          <p className="text-primary mb-3">Olá, eu sou</p>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-gradient glow">
            Félix Bastian
          </h1>
          ...
          <p className="text-muted-foreground max-w-lg mb-8">
            Criando experiências digitais impactantes através de código limpo e design intuitivo.
